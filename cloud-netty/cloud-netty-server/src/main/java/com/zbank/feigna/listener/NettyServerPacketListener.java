package com.zbank.feigna.listener;

import com.alibaba.fastjson2.JSONObject;
import com.alibaba.fastjson2.TypeReference;
import com.alibaba.fastjson2.util.DateUtils;
import com.zbank.feigna.enums.NettyPacketType;
import com.zbank.feigna.socket.NettyPacket;
import com.zbank.feigna.socket.NettyPacketEvent;
import com.zbank.feigna.socket.NettyServer;
import com.zbank.feigna.vo.RequestTestVO;
...
public class NettyServerPacketListener implements ApplicationListener<NettyPacketEvent> {
    ...
    private void requestTest1(ChannelId channelId, String requestId, RequestTestVO param) {
        ...
        ResponseTestVO response = ResponseTestVO.builder().message("server receive param").date(DateUtils.format(new Date())).build();
